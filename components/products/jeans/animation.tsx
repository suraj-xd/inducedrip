...
const initialItemsData = [
  ...
  // },
  {
    id: "item-10",
    label: "35-510x510",
    image: "/patches/35-510x510 Background Removed.png",
    color: "bg-gradient-to-br from-purple-500 to-purple-800",
  },
  {
    id: "item-11",
    label: "54-copy-1",
    image: "/patches/54-copy-1-510x510 Background Removed.png",
          ...
          <AnimatePresence>
            {selectedItem && (
              ...
              >
                ...
                <motion.div
                  className="relative size-20 rounded-2xl overflow-hidden bg-transparent shadow-none border-none outline-none focus:outline-none focus-within:outline-none ring-0 "
