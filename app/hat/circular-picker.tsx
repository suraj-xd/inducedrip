...
const initialItemsData = [
  ...
  // },
  {
    ...
    label: "Bro Code",
    image:
      "/patches/chatgpt/ChatGPT Image Jun 19, 2025, 01_16_08 PM.png",
...
export default function CircularPickerHat({ className }: CircularPickerProps) {
  ...
  return (
    <LayoutGroup>
      ...
      >
        <div className="flex items-center justify-center w-full h-3/5 pt-[12rem] min-h-[180px] sm:min-h-[240px]">
          <AnimatePresence>
            {selectedItem && (
              <motion.div
              ...
              >
                ...
                <motion.div
                  className="relative size-12  overflow-hidden bg-transparent shadow-none border-none outline-none focus:outline-none focus-within:outline-none ring-0 "
                ...
                >
                  <Image
                    ...
                    fill
                    className="object-cover image-outlined-animated shadow-none border-none outline-none focus:outline-none focus-within:outline-none ring-0 "
                    sizes="(max-width: 640px) 96px, 128px"
                  />
                  <div className="absolute inset-0 shadow-none border-none outline-none focus:outline-none focus-within:outline-none ring-0 " />
                </motion.div>
        ...
        <div className="flex items-center justify-center space-x-2 sm:space-x-3 w-full h-2/5 pt-4 sm:pt-6 flex-wrap gap-y-3 overflow-y-auto max-h-[200px]">
